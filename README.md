...
const PROJECT_CONFIG = {
    emailToCopy: "ronald@ronaldding.com",
    leftMenu: [
      { icon: "🏠", label: "Home", url: "https://intranet/Pages/newhome.aspx?Cwpmode=CurrentUser" },
      { icon: "📄", label: "e-Leave", url: "https://hehhrw001:7443/eLeave" },
      { icon: "📊", label: "NHGIS", url: "https://nhgis-web.hkelectric.heh.net/nhgis_web/site/" },
      { icon: "📈", label: "SOM", url: "https://hehsam001/SOM/ClickOnce/Hec.SOM.application" },
      { icon: "📁", label: "OneDrive", url: "https://hkelectric-my.sharepoint.com/my", action: "copyEmail" },
      { icon: "💬", label: "Teams", url: "https://teams.microsoft.com/v2/?showPwaInstall=true", action: "copyEmail" },
      { icon: "📧", label: "Outlook", url: "https://email.hkelectric.com/", action: "copyEmail" },
      { icon: "🍽️", label: "Canteen Menu", url: "https://intranet/sites/hrna/administration/pages/eatery/eatery-et-menu.aspx" },
      { icon: "💡", label: "e-connect", url: "https://exp.hkelectric.com/eucw/web/launch.php", action: "copyEmail" },
      { icon: "📋", label: "Org Chart", url: "https://intranet/Organization%20Chart/Transmission%20and%20Distribution-full%20set.pdf" },
      { icon: "👥", label: "People On The Move", url: "https://intranet/sites/hrna/hrsch/pages/people-on-the-move.aspx" },
      { icon: "📘", label: "GT TT ROTA", url: "https://intranet/sites/tnd/lists/trainee%202%20apprentice%20information/allitems.aspx" },
      { icon: "🎯", label: "LMArena", url: "https://lmarena.ai/" },
      { icon: "🔒", label: "i-Learn", url: "https://hkelectric-sso.sabacloud.com/" },
      { icon: "🔔", label: "樂樂營", url: "https://hehcws001/sbSystem/sbMain.aspx" }
    ],
    rightMenu: [
      { icon: "🔍", label: "Search", action: "loadSearch" },
      { icon: "🎵", label: "QR Code", action: "loadQR" },
      { icon: "1️⃣", label: "page 1", iframe: "pages/1.html" },
      { icon: "2️⃣", label: "page 2", iframe: "2.html" },
      { icon: "3️⃣", label: "page 3", iframe: "3.html" }
    ],
    searchModes: [
      { name: "Google", url: "https://www.google.com/search?q=" },
      { name: "People", url: "https://intranet/sites/search/Pages/peopleresults.aspx?k=" },
      { name: "File", url: "https://intranet/_layouts/15/osssearchresults.aspx?u=https%34%2F%2Fintranet&k=" },
      { name: "CDMS", url: "https://newcdms.hkelectric.heh.net/CDMS/SearchCenter/Pages/DrawingDocumentResults.aspx?k=" }
    ]
};
</script>
<head>
